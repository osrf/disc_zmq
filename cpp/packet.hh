...
static char *msgTypesStr[] = {
    NULL, const_cast<char*>("ADVERTISE"), const_cast<char*>("SUBSCRIBE"),
    const_cast<char*>("ADV_SRV"), const_cast<char*>("SUB_SVC"),
    const_cast<char*>("PUB"), const_cast<char*>("REQ"),
    const_cast<char*>("SRV_REP_OK"), const_cast<char*>("SRV_REP_ERROR")
};
